...
class NiebieskiKwadrat(Kwadrat):
    def sketchNiebieski ( self, x, y, kolor):
        Kwadrat.sketch ( self, x, y)
...
def setup():
    ...
    malyNiebieskiKwadrat.sketchNiebieski(50, 20, 8)
    malyNiebieskiKwadrat.sketchNiebieski(70, 50, 8)
    duzyNiebieskiKwadrat = NiebieskiKwadrat(40.0)
    duzyNiebieskiKwadrat.sketchNiebieski(300, 20, 5)
    duzyNiebieskiKwadrat.sketchNiebieski(300, 70, 5)
